...
- O fluxo de idempotência da U1V8 (sequence diagram)
- O ciclo DLQ da U1V9 (state diagram)
- A tabela **Componentes e Responsabilidades** — mapeamento arquivo → responsabilidade
